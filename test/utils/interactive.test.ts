...
describe('interactive utilities', () => {
  let originalOGDInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalOGDInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalOGDInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalOGDInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
