## Why
Add support for Crush AI assistant in OGD to enable developers to use Crush's enhanced capabilities for spec-driven development workflows.
...
- New files: .crush/commands/ogd/ (proposal.md, apply.md, archive.md)