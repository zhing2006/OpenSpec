...
- **BREAKING**: Existing Cline users will need to re-run `ogd init` to get the corrected workflow files
...
- Modified files: `.clinerules/workflows/OGD-*.md` (moved from `.clinerules/OGD-*.md`)
