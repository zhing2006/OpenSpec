# Adopt Future State Storage for OGD Changes
...
- Add new `OGD-conventions` capability to document these conventions



## Impact

- Affected specs: New `OGD-conventions` capability
- Affected code:
  - ogd/README.md (lines 85-108)
  - docs/PRD.md (lines 376-382, 778-783)
  - docs/OGD-walkthrough.md (lines 58-62, 112-126)
  - ogd/changes/add-init-command/ (migration needed)
