...
- Search existing work: `OGD spec list --long`, `ogd list` (use `rg` only for full-text search)
...
**Workflow**
1. Review `ogd/project.md`, `ogd list`, and `ogd list --specs` to understand current context.
...
- [ ] Read `ogd/project.md` for conventions
